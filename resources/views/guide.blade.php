...
<div class="px-4 py-5 my-5 text-center">
  ...
  <div class="col">
    <div class="card">
      <img src="https://bootdey.com/img/Content/avatar/avatar3.png" class="rounded mx-auto d-block" alt="...">
      <div class="card-body">
  ...
  <div class="col">
    <div class="card">
      <img src="https://bootdey.com/img/Content/avatar/avatar8.png" class="rounded mx-auto d-block" alt="...">
      <div class="card-body">
  ...
  <div class="col">
    <div class="card">
      <img src="https://bootdey.com/img/Content/avatar/avatar5.png" class="rounded mx-auto d-block" alt="...">
      <div class="card-body">
  ...
  <div class="col">
    <div class="card">
      <img src="https://bootdey.com/img/Content/avatar/avatar7.png" class="rounded mx-auto d-block" alt="...">
      <div class="card-body">
...
<div class="col-md-10 col-lg-8 col-xl-6">
  <div class="form-floating mb-3">
              <select class="form-select" id="floatingSelect" aria-label="Floating label select example" name="guide">
                <option selected>Pilih</option>
                @foreach($guide as $guide) 
                <option value="{{$guide->nama_guide}}">{{$guide->nama_guide}}</option>
                @endforeach
              </select>
              <label for="floatingSelect">Pilih Tour Guide</label>
    </div>
    <input type="hidden" name="id" value="{{$id}}">
    <input type="hidden" name="p_wisata" value="{{$p_wisata}}">
</div>
<div class="col-md-2">
<button type="submit" class="btn btn-md btn-primary w-100">Lanjutkan</button>
</form>
</div>
</div>
</body>
